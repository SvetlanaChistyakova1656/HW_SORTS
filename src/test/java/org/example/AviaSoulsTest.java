...
public class AviaSoulsTest {
    ...
    public void testSortByPrice() {
        ...
        Ticket ticket3 = new Ticket("MSK", "UFA", 200, 10, 17);
        Ticket ticket4 = new Ticket("MSK", "SPB", 400, 7, 8);
        Ticket ticket5 = new Ticket("UFA", "SPB", 800, 4, 10);
        Ticket ticket6 = new Ticket("MSK", "SPB", 200, 6, 11);
        Ticket ticket7 = new Ticket("KRS", "KMR", 300, 15, 18);
        Ticket ticket8 = new Ticket("MSK", "SPB", 500, 7, 7);
    ...
    public void testSortZeroTickets() {
        ...
        Ticket[] actual = manager.search("KMR", "MSK");
        Ticket[] expected = {};
        Assertions.assertArrayEquals(expected, actual);
    }
    ...
    public void testSortOneTickets() {
        ...
        Ticket[] actual = manager.search("KRS", "KMR");
    ...
    public void testSortOneTicketsWithComparator() {
        ...
        Ticket[] actual = manager.search("KRS", "KMR",comparator);
        Ticket[] expected = {ticket7};
        Assertions.assertArrayEquals(expected, actual);
    }
    ...
    public void testSortZeroTicketsWithComparator() {
        ...
        Ticket[] actual = manager.search("KMR", "MSK",comparator);
        Ticket[] expected = {};
        Assertions.assertArrayEquals(expected, actual);
    }
}
